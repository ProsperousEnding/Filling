      ...
      <div class="flex items-center justify-between gap-3">
        ...
        <div v-if="showActions" class="site-header-actions flex shrink-0 items-center gap-1.5">
          ...
          <button
            ...
            @click="toggleTheme"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="site-header-theme-icon-light h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" class="site-header-theme-icon-dark h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
.site-header-theme-icon-dark {
  display: none;
}

:global(html.dark .site-header-theme-icon-light) {
  display: none;
}

:global(html.dark .site-header-theme-icon-dark) {
  display: block;
}
